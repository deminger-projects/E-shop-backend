...
function insert_records(tables, columns, values) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let query_index = 0; query_index < tables.length; query_index++) {
            if (query_index === 0) {
                const result = yield (0, query_request_1.default)(sql_inserts[query_index], [values[query_index]]);
                ...
                yield (0, query_request_1.default)(sql_inserts[query_index], [values[query_index]]);
            }
        }
        return record_id;
    });
