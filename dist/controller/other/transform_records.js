...
function transform_records(records) {
    ...
    return { tables: tables, columns: columns, values: new_values, wheres: { columns: where_cols, values: where_vals } };
}
exports.default = transform_records;
