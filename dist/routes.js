...
exports.router.post('/add_record', validate_cart_data_js_1.default, request_data_transformer_js_1.default, check_for_duplicit_record_js_1.default, (0, try_catch_js_1.default)(function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (req.files) {
            yield (0, save_files_js_1.default)("./public/images/temp/" + JSON.parse(req.body.folder) + "/" + record_id + "/", req.files);
            (0, modify_images_js_1.default)("./public/images/temp/" + JSON.parse(req.body.folder) + "/" + record_id + "/", record_id, JSON.parse(req.body.folder));
        }
